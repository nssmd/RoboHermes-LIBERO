...
# Robot-frame sides: base sits at -x, so +x points AWAY from the robot. y is the
# robot's own left(+)/right(-). Callers can override with explicit dx/dy/dz if a
# task's "right" differs from the robot frame.
_SIDE = {
    "front": (1.0, 0.0),
    "back": (-1.0, 0.0),
    "left": (0.0, 1.0),
