...
from robohermes.embodied.sim.libero.run_records import classify_infrastructure_exception
...
def responses_probe_request(
    ...
    *,
    ...
    key = auth_token or os.environ.get("ROBOHERMES_OPENAI_API_KEY") or os.environ.get("OPENAI_API_KEY")
    if not key:
    ...
    client = OpenAI(
        ...
        base_url=(
            base_url
            or os.environ.get("ROBOHERMES_OPENAI_BASE_URL")
