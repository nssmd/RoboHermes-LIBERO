...
def _responses_reasoning_effort() -> str:
    requested = os.environ.get("ROBOHERMES_REASONING_EFFORT", "medium").strip().lower()
...
def _responses_client():
    ...
    key = os.environ.get("ROBOHERMES_OPENAI_API_KEY") or os.environ.get("OPENAI_API_KEY")
    if not key:
        raise RuntimeError("OPENAI_API_KEY is not configured")
    base_url = (
        os.environ.get("ROBOHERMES_OPENAI_BASE_URL")
