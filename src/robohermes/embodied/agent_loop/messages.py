...
def _initial_messages(
    ...
    *,
    ...
    from robohermes.embodied.agent_loop.prompt_tools import _system_prompt

    task_definition = ""
    if task_name and include_skill_task_truth:
        from robohermes.embodied.skills import get
...
def _append_image(convo: list[dict[str, Any]], path: Path) -> list[dict[str, Any]]:
    ...
    from robohermes.embodied.agent_loop.vlm_io import _compact_responses_image_url
