...
Default root: ``~/.robohermes/data`` (will become ``~/.robohermes/data`` after
...
from robohermes.data.trajectory import WrittenEpisode, write_rollout
from robohermes.embodied.paths import data_root
from robohermes.embodied.agent_loop.env import Rollout
