...
from robohermes_libero.config import (
    ReleaseConfig,
    detect_gpu_devices,
    load_config,
    write_config,
...
app = typer.Typer(
    name="robohermes-libero",
    help="Configure, evaluate, and inspect RoboHermes on LIBERO short.",
...
@app.command()
def configure(
    output: Annotated[Path, typer.Option("--output", "-o")] = Path("robohermes.yaml"),
...
def eval_libero_short(
    config: Annotated[Path, typer.Option("--config", "-c")] = Path("robohermes.yaml"),
    ...
    if dry_run:
        ...
        return
    from robohermes_libero.launcher import launch_evaluation
...
def doctor(
    ...
    from robohermes_libero.doctor import run_doctor
...
def dashboard(
    ...
    from robohermes_libero.dashboard import serve_dashboard
...
def services_start(
    ...
    from robohermes_libero.services import start_service
...
def services_status() -> None:
    ...
    from robohermes_libero.services import service_status
...
def services_stop() -> None:
    ...
    from robohermes_libero.services import stop_service
