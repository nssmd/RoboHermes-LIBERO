...
class ReleaseConfig(BaseModel):
    ...
    def runtime_environment(self, source: Mapping[str, str] | None = None) -> dict[str, str]:
        ...
        env = {
            "ROBOHERMES_VLM_MODEL": self.provider.model,
            "ROBOHERMES_PERCEPTION_MODEL": self.provider.model,
            "ROBOHERMES_REASONING_EFFORT": self.provider.reasoning_effort,
            "ROBOHERMES_OPENAI_BASE_URL": self.provider.base_url,
            "ROBOHERMES_OPENAI_API_KEY": key,
            "ROBOHERMES_LIBERO_ROOT": str(self.simulator.root),
            "LIBERO_CONFIG_PATH": str(self.simulator.config_root),
            "ROBOHERMES_LIBERO_RES": str(self.simulator.image_size),
            "ROBOHERMES_LIBERO_HORIZON": str(self.simulator.horizon),
            "ROBOHERMES_LIBERO_CONTROLLER": self.simulator.controller,
            "ROBOHERMES_PYROKI_PORT": str(self.services.pyroki_port),
            "ROBOHERMES_SAM3_PORT": str(self.services.sam_port),
