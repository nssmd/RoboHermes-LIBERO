...
from robohermes_libero.config import ReleaseConfig
from robohermes_libero.protocol import CampaignState
...
def create_campaign(
    ...
    *,
    ...
    manifest = {
        "schema": "robohermes.libero_short_campaign.v1",
