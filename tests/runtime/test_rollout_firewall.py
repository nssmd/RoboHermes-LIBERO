...
from robohermes.embodied.agent_loop import rollout
from robohermes.embodied.agent_loop.env import Observation
...
def test_simulator_predicate_runs_once_after_visible_tool_loop(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setenv("ROBOHERMES_COLLECT", "0")
    monkeypatch.setenv("ROBOHERMES_SELFEVO_FREEZE", "1")
