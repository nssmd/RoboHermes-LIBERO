#!/usr/bin/env python3
"""Create an isolated public RoboHermes LIBERO installation."""
...
def bootstrap_commands(
    *,
    ...
    executable = venv / "bin" / "robohermes-libero"
    ...
    commands.extend(
        [
            [str(executable), "configure", "--output", str(root / "robohermes.yaml"), "--yes"],
        ]
    )
    if core_only:
        commands.append(
